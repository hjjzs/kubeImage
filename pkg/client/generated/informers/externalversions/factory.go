...
import (
	...
	builder "builder/pkg/client/generated/informers/externalversions/builder"
	image "builder/pkg/client/generated/informers/externalversions/image"
...
func (f *sharedInformerFactory) Builder() builder.Interface {
	return builder.New(f, f.namespace, f.tweakListOptions)
}
